...
- [x] Add `calculate_semantic_entropy()` stub to operations.py
- [x] Add `get_dynamic_threshold()` reading from calibration_log.json
- [x] Update `persist_soul()` with Dead-Man's Switch
- [x] Update `persist_soul_full()` with Dead-Man's Switch
- [x] Add Global Floor (0.95) to calibration_log.json
- [x] Rebuild Podman image and restart container (Logic verified via stress test script)
- [x] Verify tools are operational
