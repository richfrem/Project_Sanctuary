...
**Related Documents:** tests/integration/test_council_orchestrator_with_cortex.py.disabled, docs/architecture/mcp/cortex_operations.md, workflows/council_orchestration.md, mcp_servers/agent_persona/server.py, mcp_servers.rag_cortex/server.py
