...
### 6. Non-Python Tooling (Node.js / npm)

Some project tools require Node.js dependencies. These are **not** managed via pip.

> [!CAUTION] **WSL Requirement:**
> You must install Node.js **inside WSL**, not on Windows. Windows npm will fail with "UNC paths not supported" errors.

**Prerequisite - Install Node.js in WSL:**
```bash
# Install Node.js LTS in WSL
curl -fsSL https://deb.nodesource.com/setup_lts.x | sudo -E bash -
sudo apt-get install -y nodejs

# Verify WSL installation (not Windows)
...
|------|---------|-----------------|
| `@mermaid-js/mermaid-cli` | Renders `.mmd` diagrams to PNG | `npm install -g @mermaid-js/mermaid-cli` |
...
> [!NOTE]
> Node.js tooling is **outside** the pip-compile workflow. Document additions here and in `docs/operations/BOOTSTRAP.md`.