...
|:---|:---|:---|:---|
| `RAG_STRATEGIES_AND_DOCTRINE.md` | 46KB architectural deep dive | Should be in `docs/architecture/mcp/cortex/` | ❌ **Missing** |
| `VISION.md` | Strategic vision | Should be in `docs/architecture/mcp/cortex/` | ❌ **Missing** |
| `OPERATIONS_GUIDE.md` | User guide | Should be in `docs/architecture/mcp/cortex/` | ❌ **Missing** |
| `EVOLUTION_PLAN_PHASES.md` | Roadmap | Should be in `docs/architecture/mcp/cortex/` | ❌ **Missing** |
| `adr/` (4 ADRs) | Architecture decisions | Should be in `docs/architecture/mcp/cortex/adr/` | ❌ **Missing** |
| `INQUIRY_TEMPLATES/` | Protocol 87 templates | Should be in `docs/architecture/mcp/cortex/templates/` | ❌ **Missing** |
...
**Action**: Move the following to `docs/architecture/mcp/cortex/`:
...
### Phase 2: Migration
- [ ] All docs in `docs/architecture/mcp/cortex/`
