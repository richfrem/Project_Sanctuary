...
4. **Architecture Specification:** `docs/architecture/mcp_gateway/ARCHITECTURE.md`
5. **Operations Reference:** `docs/architecture/mcp_gateway/OPERATIONS.md`
6. **Deployment Guide:** `docs/architecture/mcp_gateway/DEPLOYMENT.md`
7. **Testing Strategy:** `docs/architecture/mcp_gateway/TESTING.md`
...
- `docs/architecture/mcp/architecture.md` → Add Gateway section
- `docs/architecture/mcp/QUICKSTART.md` → Update with Gateway instructions
- `README.md` → Update architecture diagram

**Create New Docs:**
- `docs/architecture/mcp_gateway/ARCHITECTURE.md` → Gateway architecture
- `docs/architecture/mcp_gateway/OPERATIONS.md` → Operations reference
- `docs/architecture/mcp_gateway/DEPLOYMENT.md` → Deployment guide
- `docs/architecture/mcp_gateway/TESTING.md` → Testing guide
- `docs/architecture/mcp_gateway/TROUBLESHOOTING.md` → Common issues
...
- [ ] `docs/architecture/mcp_gateway/ARCHITECTURE.md`
- [ ] `docs/architecture/mcp_gateway/OPERATIONS.md`
- [ ] `docs/architecture/mcp_gateway/DEPLOYMENT.md`
- [ ] `docs/architecture/mcp_gateway/TESTING.md`
- [ ] `docs/architecture/mcp_gateway/TROUBLESHOOTING.md`
...
**docs/architecture/mcp_gateway/MIGRATION.md:**
- Migration checklist
...
4. **Create Architecture Docs:** `docs/architecture/mcp_gateway/ARCHITECTURE.md`
5. **Create Operations Reference:** `docs/architecture/mcp_gateway/OPERATIONS.md`
...
# (See separate file: docs/architecture/mcp_gateway/api_spec.yaml)
```
...
# (See separate file: docs/architecture/mcp_gateway/benchmarks.md)
```
