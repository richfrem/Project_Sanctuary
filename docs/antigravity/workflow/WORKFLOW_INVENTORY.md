...
| `/workflow-bundle` | - | Create a markdown bundle from a set of files using a manifest. | - |
...
| `/workflow-bundle` | Factory | Create a markdown bundle from a set of files using a manifest. |
...
| `/workflow-tool-update` | Curate | Update tool inventories, RLM cache, and associated artifacts after creating or modifying tools. |