...
TRACKING_FILE = Path('legacy-system/reference-data/ai_analysis_tracking.json')
OUTPUT_FILE = Path('TODO_PENDING_ANALYSIS.md')

WORKFLOW_FILE = Path('legacy-system/business-workflows/BC_Criminal_Justice_Workflow_Summary.md')
APPS_DIR = Path('legacy-system/applications')
