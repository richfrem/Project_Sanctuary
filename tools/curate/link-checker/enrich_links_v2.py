...
Usage Examples:
    python tools/curate/link-checker/enrich_links_v2.py --help
...
# =============================================================================
CWD = Path.cwd()
MASTER_COLLECTION_PATH = CWD / 'legacy-system' / 'reference-data' / 'master_object_collection.json'
ORPHANED_ROLES_PATH = CWD / 'legacy-system' / 'reference-data' / 'orphaned_roles.json'
