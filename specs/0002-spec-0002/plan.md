...
- [ ] Verify `bundle.py` is in `plugins/tool-inventory/skills/tool-inventory/scripts/tool_inventory.json`. If not, add it.
- [ ] Run `plugins/rlm-factory/skills/rlm-curator/scripts/query_cache.py "bundle"` to confirm visibility.
...
- [ ] Run `python3 plugins/context-bundler/scripts/bundle.py temp_bundler_test/test_manifest.json -o temp_bundler_test/bundle.md`.
