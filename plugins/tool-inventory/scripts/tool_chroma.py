...
Usage:
    ...
    # As a CLI
    python3 tool_chroma.py stats
    python3 tool_chroma.py search "query cache"
    python3 tool_chroma.py list
    python3 tool_chroma.py import-json path/to/rlm_tool_cache.json
"""
