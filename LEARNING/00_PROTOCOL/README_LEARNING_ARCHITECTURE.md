...
> ⚠️ **DEPRECATED:** This guide covers ChromaDB v1.0. See [ChromaDB v2.0 Guide](#new-note-link) for current information.
...
**Conflicting Sources:**
- [Source A](#source) claims 10k docs/sec
- [Source B](#source) claims 50k docs/sec
...
**Conflicting Sources:**
- [Source A](#source) recommends FastAPI
- [Source B](#source) recommends Django
- [Source C](#source) recommends Flask
