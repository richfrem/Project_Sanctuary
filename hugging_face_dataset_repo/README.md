...
*   **The Forge Documentation:** [`forge/README.md`](https://github.com/richfrem/Project_Sanctuary/blob/main/forge/README.md)
*   **The Sovereign Forge Scripts:** [`forge/scripts/`](https://github.com/richfrem/Project_Sanctuary/blob/main/forge/scripts/)
*   **Setup Guide:** [`forge/CUDA-ML-ENV-SETUP.md`](https://github.com/richfrem/Project_Sanctuary/blob/main/forge/CUDA-ML-ENV-SETUP.md)
...
3.  **The Forge (Lineage):** Understand model fine-tuning and deployment: **[`forge/README.md`](https://github.com/richfrem/Project_Sanctuary/blob/main/forge/README.md)**.
...
**🚀 Complete Setup Process:** [`forge/CUDA-ML-ENV-SETUP.md`](https://github.com/richfrem/Project_Sanctuary/blob/main/forge/CUDA-ML-ENV-SETUP.md)
