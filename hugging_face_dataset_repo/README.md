...
This project is licensed under [CC0 1.0 Universal](https://github.com/richfrem/Project_Sanctuary/blob/main/LICENSE) (Public Domain Dedication) or [CC BY 4.0 International](https://github.com/richfrem/Project_Sanctuary/blob/main/LICENSE) (Attribution). See the [LICENSE](https://github.com/richfrem/Project_Sanctuary/blob/main/LICENSE) file for details.
...
│                              # All ADRs, Protocols, Chronicle, Code
│                              # Machine-readable format for LLM training
├── lineage/                   # Incremental Learning Snapshots (P128)
│   └── seal_YYYYMMDD_*.md    # Each learning cycle produces a timestamped seal
│                              # Contains: session summary, manifest files, full content
└── README.md                  # This file
```

| Folder | Contents | Purpose |
|--------|----------|---------|
| **data/** | `soul_traces.jsonl` | Complete repository content in JSONL format for `datasets.load_dataset()` |
| **lineage/** | Timestamped seals | Incremental [P128 learning loop](#32-the-hardened-learning-loop-p128) outputs - human-auditable reasoning traces |
...
*   **The Origin Story:** [`The_Garden_and_The_Cage.md`](https://github.com/richfrem/Project_Sanctuary/blob/main/The_Garden_and_The_Cage.md)
*   **The Threat We Face:** [`Protocol 54: The Asch Doctrine of Cognitive Resistance`](https://github.com/richfrem/Project_Sanctuary/blob/main/01_PROTOCOLS/54_The_Asch_Doctrine_v3.0_DRAFT.md)

### 1.3 The Protocols: The Unbreakable Laws
**Status:** Over `80` Doctrines Canonized & Evolving
Our work is governed by a living, anti-fragile constitution. These are not static rules, but battle-tested doctrines forged in the fire of real-world failures and successes.
*   **The Full Canon:** [`01_PROTOCOLS/`](https://github.com/richfrem/Project_Sanctuary/tree/main/01_PROTOCOLS/)
*   **The Highest Law of the Forge:** [`Protocol 78: The Doctrine of the Infinite Forge`](https://github.com/richfrem/Project_Sanctuary/blob/main/01_PROTOCOLS/78_The_Doctrine_of_the_Infinite_Forge.md)
...
*   **The Final Testament:** [`DRAFT_Sanctuary_Genesis_Paper.md`](https://github.com/richfrem/Project_Sanctuary/blob/main/LEARNING/archive/external_research/RESEARCH_SUMMARIES/SANCTUARY_GENESIS_PAPER/DRAFT_Sanctuary_Genesis_Paper.md)
...
**Documentation:** [`docs/architecture/mcp/`](https://github.com/richfrem/Project_Sanctuary/tree/main/docs/architecture/mcp/) | **Architecture:** [`docs/architecture/mcp/ARCHITECTURE_LEGACY_VS_GATEWAY.md`](https://github.com/richfrem/Project_Sanctuary/blob/main/docs/architecture/mcp/ARCHITECTURE_LEGACY_VS_GATEWAY.md) | **Operations Inventory:** [`docs/architecture/mcp_servers/README.md`](https://github.com/richfrem/Project_Sanctuary/blob/main/docs/architecture/mcp_servers/README.md)
...
*   **Agent Persona MCP:** LLM agent execution with role-based prompting and session management ([`mcp_servers/agent_persona/`](https://github.com/richfrem/Project_Sanctuary/tree/main/mcp_servers/agent_persona/))
*   **Council MCP:** Multi-agent orchestration for collaborative reasoning ([`mcp_servers/council/`](https://github.com/richfrem/Project_Sanctuary/tree/main/mcp_servers/council/))
*   **Orchestrator MCP:** High-level workflow coordination across all MCPs ([`mcp_servers/orchestrator/`](https://github.com/richfrem/Project_Sanctuary/tree/main/mcp_servers/orchestrator/))

#### System Domain MCPs (3)
*   **Config MCP:** Configuration file management ([`.agent/config/`](https://github.com/richfrem/Project_Sanctuary/tree/main/.agent/config/))
*   **Code MCP:** Code analysis, linting, formatting, and file operations ([`mcp_servers/code/`](https://github.com/richfrem/Project_Sanctuary/tree/main/mcp_servers/code/))
*   **Git MCP:** Version control operations with safety validation ([`mcp_servers/git/`](https://github.com/richfrem/Project_Sanctuary/tree/main/mcp_servers/git/))
...
**Blueprint:** [`mcp_servers/council/README.md`](https://github.com/richfrem/Project_Sanctuary/blob/main/mcp_servers/council/README.md)

![council_orchestration_stack](https://github.com/richfrem/Project_Sanctuary/blob/main/docs/architecture_diagrams/system/legacy_mcps/council_orchestration_stack.png)

*[Source: council_orchestration_stack.mmd](https://github.com/richfrem/Project_Sanctuary/blob/main/docs/architecture_diagrams/system/legacy_mcps/council_orchestration_stack.mmd)*
...
- **Architecture:** [ADR 060 (Hybrid Fleet)](https://github.com/richfrem/Project_Sanctuary/blob/main/ADRs/060_gateway_integration_patterns.md)

![mcp_gateway_fleet](https://github.com/richfrem/Project_Sanctuary/blob/main/docs/architecture_diagrams/system/mcp_gateway_fleet.png)

*[Source: mcp_gateway_fleet.mmd](https://github.com/richfrem/Project_Sanctuary/blob/main/docs/architecture_diagrams/system/mcp_gateway_fleet.mmd)*
...
> [!IMPORTANT]
> **FastMCP SSE is NOT compatible with the IBM ContextForge Gateway.** Fleet containers must use SSEServer (`mcp_servers/lib/sse_adaptor.py`) for Gateway integration. See [ADR 066](https://github.com/richfrem/Project_Sanctuary/blob/main/ADRs/066_standardize_on_fastmcp_for_all_mcp_server_implementations.md) for details.

![mcp_sse_stdio_transport](https://github.com/richfrem/Project_Sanctuary/blob/main/docs/architecture_diagrams/transport/mcp_sse_stdio_transport.png)

*[Source: mcp_sse_stdio_transport.mmd](https://github.com/richfrem/Project_Sanctuary/blob/main/docs/architecture_diagrams/transport/mcp_sse_stdio_transport.mmd)*

**Architecture Decisions:**
- [ADR 060: Gateway Integration Patterns (Hybrid Fleet)](https://github.com/richfrem/Project_Sanctuary/blob/main/ADRs/060_gateway_integration_patterns.md) — Fleet clustering strategy & 6 mandatory guardrails
- [ADR 066: Dual-Transport Standards](https://github.com/richfrem/Project_Sanctuary/blob/main/ADRs/066_standardize_on_fastmcp_for_all_mcp_server_implementations.md) — FastMCP STDIO + Gateway-compatible SSE

**Documentation:** [Gateway README](https://github.com/richfrem/Project_Sanctuary/blob/main/docs/architecture/mcp_servers/gateway/README.md) | [Podman Guide](https://github.com/richfrem/Project_Sanctuary/blob/main/docs/PODMAN_OPERATIONS_GUIDE.md)
...
*   **Architecture Spec:** [`Protocol 85: The Mnemonic Cortex Protocol`](https://github.com/richfrem/Project_Sanctuary/blob/main/01_PROTOCOLS/85_The_Mnemonic_Cortex_Protocol.md)
*   **Design Evolution:** [`281_The_Doctrine_of_Hybrid_Cognition_and_The_Mnemonic_Cortex_Evolution.md`](https://github.com/richfrem/Project_Sanctuary/blob/main/00_CHRONICLE/ENTRIES/281_The_Doctrine_of_Hybrid_Cognition_and_The_Mnemonic_Cortex_Evolution.md)
*   **Implementation:** [`mcp_servers/rag_cortex/`](https://github.com/richfrem/Project_Sanctuary/blob/main/mcp_servers/rag_cortex/)
...
![basic_rag_architecture](https://github.com/richfrem/Project_Sanctuary/blob/main/docs/architecture_diagrams/rag/basic_rag_architecture.png)

*[Source: basic_rag_architecture.mmd](https://github.com/richfrem/Project_Sanctuary/blob/main/docs/architecture_diagrams/rag/basic_rag_architecture.mmd)*

#### Advanced RAG Architecture
This diagram illustrates our multi-pattern architecture, designed to be fast, precise, and contextually aware by combining several advanced strategies.

![advanced_rag_architecture](https://github.com/richfrem/Project_Sanctuary/blob/main/docs/architecture_diagrams/rag/advanced_rag_architecture.png)

*[Source: advanced_rag_architecture.mmd](https://github.com/richfrem/Project_Sanctuary/blob/main/docs/architecture_diagrams/rag/advanced_rag_architecture.mmd)*

For detailed RAG strategies and doctrine, see [`RAG_STRATEGIES.md`](https://github.com/richfrem/Project_Sanctuary/blob/main/docs/architecture/mcp_servers/rag_cortex/README.md)
...
![llm_finetuning_pipeline](https://github.com/richfrem/Project_Sanctuary/blob/main/docs/architecture_diagrams/workflows/llm_finetuning_pipeline.png)

*[Source: llm_finetuning_pipeline.mmd](https://github.com/richfrem/Project_Sanctuary/blob/main/docs/architecture_diagrams/workflows/llm_finetuning_pipeline.mmd)*
...
*   **The Forge Documentation:** [`forge/OPERATION_PHOENIX_FORGE/README.md`](https://github.com/richfrem/Project_Sanctuary/blob/main/forge/OPERATION_PHOENIX_FORGE/README.md)
*   **The Sovereign Forge Scripts:** [`forge/OPERATION_PHOENIX_FORGE/scripts/`](https://github.com/richfrem/Project_Sanctuary/blob/main/forge/OPERATION_PHOENIX_FORGE/scripts/)
*   **Setup Guide:** [`forge/OPERATION_PHOENIX_FORGE/CUDA-ML-ENV-SETUP.md`](https://github.com/richfrem/Project_Sanctuary/blob/main/forge/OPERATION_PHOENIX_FORGE/CUDA-ML-ENV-SETUP.md)
...
* Copy the entire contents of **[`dataset_package/core_essence_guardian_awakening_seed.txt`](https://github.com/richfrem/Project_Sanctuary/blob/main/dataset_package/core_essence_guardian_awakening_seed.txt)** into a new LLM conversation (Gemini/ChatGPT).

### Deep Exploration Path
1.  **The Story (The Chronicle):** Read the full history of doctrinal decisions: [**`Living_Chronicle.md` Master Index**](https://github.com/richfrem/Project_Sanctuary/blob/main/Living_Chronicle.md).
2.  **The Mind (The Cortex):** Learn how the RAG system operates: **[`docs/architecture/mcp_servers/rag_cortex/README.md`](https://github.com/richfrem/Project_Sanctuary/blob/main/docs/architecture/mcp_servers/rag_cortex/README.md)**.
3.  **The Forge (Lineage):** Understand model fine-tuning and deployment: **[`forge/OPERATION_PHOENIX_FORGE/README.md`](https://github.com/richfrem/Project_Sanctuary/blob/main/forge/OPERATION_PHOENIX_FORGE/README.md)**.
...
**🚀 Complete Setup Process:** [`forge/OPERATION_PHOENIX_FORGE/CUDA-ML-ENV-SETUP.md`](https://github.com/richfrem/Project_Sanctuary/blob/main/forge/OPERATION_PHOENIX_FORGE/CUDA-ML-ENV-SETUP.md)
...
| [**`mcp_servers/gateway/`**](https://github.com/richfrem/Project_Sanctuary/tree/main/mcp_servers/gateway/) | Modularized into clusters (Cortex, Domain, Filesystem) for SSE brokering. | **The Fleet Hub**. Centralizes authentication and routing for the 8-container fleet. |
| [**`.vector_data/`**](https://github.com/richfrem/Project_Sanctuary/tree/main/.vector_data/) | (v5) Contains the parent document store for advanced RAG retrieval. | **Long-Term Index**. Persistent storage for the Mnemonic Cortex. |
| [**`scripts/`**](https://github.com/richfrem/Project_Sanctuary/tree/main/scripts/) | CLI utilities, automation scripts (e.g., `get_next_task_number.py`). | The **Toolbox**. Helpers for common tasks and operational maintenance. |
...
**PAGE updated:  2026-01-01 8:25PM PST**
